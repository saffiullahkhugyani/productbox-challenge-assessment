        ...
        <CardHeader>
          <CardTitle className={"flex items-center justify-between"}>
            <span className="text-2xl font-bold">
              Your Cart ({sampleCartItems.length} items)
            </span>
        ...
        <CardContent>
          <div className="grid grid-col-1 space-y-4 p-2">
            {sampleCartItems.map((item) => (
              <div className="flex border rounded shadow hover:shadow-lg hover:pointer hover:bg-gray-50">
                ...
                <div className=" w-full flex justify-between m-4 ">
                  ...
                  <div className="flex flex-col justify-between items-end">
                    <Trash2 className="w-4 h-4 text-red-400 mt-2 mr-2 hover:transition hover:h-6 hover:w-6" />
